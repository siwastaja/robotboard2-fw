...
OBJ = stm32init.o main.o own_std.o flash.o tof_muxing.o tof_ctrl.o tof_process.o adcs.o pwrswitch.o charger.o bldc.o imu.o audio.o sbc_comm.o timebase.o
